...
class users {
    ...
    async getUserProductsByUserName(userId) {
        ...
        var results = await client.Query("Select * from vendorproducts inner join vendorprofiles on vendorprofiles.id=vendorproducts.vendorId  where vendorprofiles.userid=?",
            [userId]);
