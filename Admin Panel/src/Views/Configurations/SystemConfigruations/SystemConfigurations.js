...
import '../Centers/node_modules/react-pro-sidebar/dist/css/styles.css';
...
class SystemConfigruations extends Component {
    constructor(props) {
        super(props)
        Action.fetchAreas();
        ...
        return (
            <React.Fragment>
                ...
                <MDBModal isOpen={this.state.areaModal} toggle={this.toggleAreasModal}>
                    <MDBModalHeader toggle={this.toggleAreasModal}>New Areas</MDBModalHeader>
                    <MDBModalBody>
...
export default SystemConfigruations;